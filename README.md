...
Perhatikan Gambar 1 diatas, proses training model menunjukkan bahwa model memiliki performa yang baik dan model konvergen pada _epochs_ sekitar 100. Dari proses ini, kita memperoleh nilai error akhir sebesar sekitar 0.0861 dan error pada data validasi sebesar 0.2628. Nilai tersebut dapat digunakan untuk membuat sistem rekomendasi.
